...
![Global Header](../images/screenshots/01_global_header.png)
...
* Account menu  
* **Create New Project** button *(visible to Admin / PM only)*  
* Notification icon

### **1.2. Account Menu**

![Account Menu](../images/screenshots/01_2_account_menu.png)
...
![Dashboard](../images/screenshots/02_dashboard.png)
...
![Activities](../images/screenshots/10_activities.png)
...
![Projects List](../images/screenshots/03_projects_list.png)
...
![Create Project Modal](../images/screenshots/03_2_create_project_modal.png)
...
* **EstimateSource** — select the official estimation method: TASK or RESOURCE *(required)*  
* Notes
...
![Project Detail](../images/screenshots/04_project_detail.png)
...
* Select staff member  
* Select project role *(flexible per project — free-text combobox with suggested values: Backend, Frontend, QC, BA, etc.)*  
* Participation period (start / end date)  
* **Estimate Hours per resource** *(only shown when EstimateSource \= RESOURCE)*
...
![Project Stakeholders](../images/screenshots/04_2_project_stakeholders.png)
...
![Task List](../images/screenshots/05_task_list.png)
...
**Columns displayed per task (Table view):** Task name, Assignee, Status, Priority, Estimate, Actual, Remaining, Start/End Date
...
* Task name *(required)*  
* Description  
* Project *(Normal Users can only select projects they belong to)*  
* Assignee *(one person only; staff can self-assign, or PM assigns)*  
...
Actual Hours are **not entered here** — they are accumulated through the Log Hours mechanism. Remaining Hours is auto-calculated \= Estimate − Actual.
...
![Task Detail](../images/screenshots/06_task_detail.png)
...
![Staff List](../images/screenshots/07_team_list.png)
...
* **Work status** *(auto-calculated — see logic below)*
...
![Staff Detail](../images/screenshots/08_team_detail.png)
...
**Performance Statistics** *(displayed as individual metrics — no single composite score)*:
...
![Reports Module](../images/screenshots/09_reports.png)
...
![System Config - Stakeholders](../images/screenshots/07_system_config_stakeholders.png)
...
![System Config - Roles](../images/screenshots/07_2_system_config_roles.png)

### **6.3. Task Status Catalog**

* Manages the workflow statuses available across the platform
* Dynamically syncs with Kanban boards

![System Config - Task Statuses](../images/screenshots/07_3_system_config_task_statuses.png)

### **6.4. Task Priority Catalog**

* Defines standardized priority levels and their color codes
* Used across Task module for visual identification

![System Config - Task Priorities](../images/screenshots/07_4_system_config_task_priorities.png)
